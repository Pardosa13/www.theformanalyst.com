...
def score_current(emit: bool = True) -> pd.DataFrame:
    ...
    out_cols = ["id", "event_id", "match_id", "commence_time", "home_team", "away_team", "player_id", "player_name", "team", "opponent", "market", "line_type", "line", "odds", "bookmaker", "recommendation", "model_prob", "edge", "confidence_score"]
