...
if (!isNaN(lastMargin) && !isNaN(lastPosition) && lastPosition > 1 && lastMargin > 0 && lastMargin <= 2.5) {
    ...
    notes += '+15.0: Close loss last start (0.5-2.5L) - competitive\n';
}
...
function calculateRunningPositionScore(runningPosition, raceDistance) {
    ...
    if (isSprint) {
        ...
        if (pos === 'LEADER')      { score = 20;  note = '+ 20.0 : LEADER in Staying race (2400m+) — Sole Leader Staying bonus (+84.9% ROI, 38 races)\n'; }
        else if (pos === 'ONPACE') { score = 0;  note = '+ 0.0 : ONPACE in Staying race\n'; }
        else if (pos === 'MIDFIELD')   { score = 0;  note = '+ 0.0 : MIDFIELD in Staying race\n'; }
