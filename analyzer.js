...
const sireData = {
    ...
    'Sebring': { runners: 25, roi: 52.0, strikeRate: 8.0 },
    
    // GOOD VALUE (30-50% ROI)
    ...
    // MODERATE VALUE (10-30% ROI)
    'Russian Revolution': { runners: 106, roi: 26.0, strikeRate: 15.1 },
    'Under The Louvre': { runners: 26, roi: 19.2, strikeRate: 19.2 },
    ...
    'Gold Standard': { runners: 23, roi: 1.7, strikeRate: 21.7 },
    'Tivaci': { runners: 38, roi: 1.6, strikeRate: 10.5 },
    'Brave Smash': { runners: 40, roi: 1.0, strikeRate: 17.5 },
    ...
    'Contributer': { runners: 30, roi: -3.3, strikeRate: 20.0 },
    'Palentino': { runners: 42, roi: -5.8, strikeRate: 11.9 },
    
    // SLIGHT NEGATIVE (-10 to -20% ROI)
    'Magnus': { runners: 80, roi: -6.1, strikeRate: 11.3 },
    'Exceed And Excel': { runners: 72, roi: -7.7, strikeRate: 12.5 },
    'Yes Yes Yes': { runners: 57, roi: -9.0, strikeRate: 17.5 },
    'Castelvecchio': { runners: 45, roi: -10.0, strikeRate: 20.0 },
    'Grunt': { runners: 44, roi: -10.1, strikeRate: 18.2 },
    'Saxon Warrior': { runners: 40, roi: -10.5, strikeRate: 20.0 },
    'Bivouac': { runners: 34, roi: -10.7, strikeRate: 23.5 },
    'Microphone': { runners: 26, roi: -12.1, strikeRate: 7.7 },
    'Alabama Express': { runners: 44, roi: -12.4, strikeRate: 15.9 },
    'Pierro': { runners: 128, roi: -12.7, strikeRate: 14.1 },
    'Blue Point': { runners: 69, roi: -13.2, strikeRate: 10.1 },
    'Sidestep': { runners: 28, roi: -14.6, strikeRate: 7.1 },
    'Highland Reel': { runners: 49, roi: -16.8, strikeRate: 8.2 },
    ...
    'Smart Missile': { runners: 72, roi: -19.2, strikeRate: 9.7 },
    'Shocking': { runners: 16, roi: -19.4, strikeRate: 18.8 },
    'Cable Bay': { runners: 49, roi: -19.4, strikeRate: 12.2 },
    'Exosphere': { runners: 30, roi: -19.7, strikeRate: 10.0 },
    
    // MODERATE NEGATIVE (-20 to -40% ROI)
    'Showtime': { runners: 36, roi: -21.7, strikeRate: 13.9 },
    'War Chant': { runners: 25, roi: -22.0, strikeRate: 8.0 },
    'I Am Immortal': { runners: 35, roi: -24.3, strikeRate: 11.4 },
    'Puissance De Lune': { runners: 61, roi: -25.6, strikeRate: 11.5 },
    'Extreme Choice': { runners: 32, roi: -26.7, strikeRate: 15.6 },
    'Exceedance': { runners: 37, roi: -27.0, strikeRate: 10.8 },
    'Denman': { runners: 31, roi: -27.1, strikeRate: 12.9 },
    'Press Statement': { runners: 59, roi: -27.5, strikeRate: 11.9 },
    'Astern': { runners: 43, roi: -28.1, strikeRate: 7.0 },
    'Sessions': { runners: 59, roi: -28.5, strikeRate: 13.6 },
    'Justify': { runners: 55, roi: -29.5, strikeRate: 16.4 },
    'So You Think': { runners: 155, roi: -30.5, strikeRate: 10.3 },
    'Zoustar': { runners: 180, roi: -31.6, strikeRate: 10.6 },
    'Hanseatic': { runners: 24, roi: -31.7, strikeRate: 16.7 },
    'Bull Point': { runners: 18, roi: -32.2, strikeRate: 16.7 },
    'Kobayashi': { runners: 28, roi: -33.0, strikeRate: 14.3 },
    'Written By': { runners: 47, roi: -33.6, strikeRate: 12.8 },
    'Cosmic Force': { runners: 33, roi: -34.2, strikeRate: 18.2 },
    'Tarzino': { runners: 26, roi: -34.6, strikeRate: 7.7 },
    'Demerit': { runners: 20, roi: -35.0, strikeRate: 5.0 },
    'Awesome Rock': { runners: 31, roi: -35.5, strikeRate: 6.5 },
    'Overshare': { runners: 42, roi: -35.8, strikeRate: 14.3 },
    'Nicconi': { runners: 63, roi: -36.7, strikeRate: 6.3 },
    'Prized Icon': { runners: 30, roi: -36.7, strikeRate: 3.3 },
    'Siyouni': { runners: 14, roi: -37.1, strikeRate: 14.3 },
    'Frankel': { runners: 25, roi: -38.8, strikeRate: 8.0 },
    'Harry Angel': { runners: 92, roi: -39.2, strikeRate: 14.1 },
    'I Am Invincible': { runners: 142, roi: -39.5, strikeRate: 10.6 },
    
    // SEVERE NEGATIVE (-40 to -60% ROI)
    'Tosen Stardom': { runners: 36, roi: -40.3, strikeRate: 5.6 },
    'Ace High': { runners: 27, roi: -40.7, strikeRate: 11.1 },
    'Rich Enuff': { runners: 54, roi: -40.9, strikeRate: 13.0 },
    'Fastnet Rock': { runners: 49, roi: -43.1, strikeRate: 10.2 },
    'Turffontein': { runners: 28, roi: -44.6, strikeRate: 7.1 },
    'Street Boss': { runners: 64, roi: -45.2, strikeRate: 10.9 },
    'Playing God': { runners: 72, roi: -45.3, strikeRate: 9.7 },
    'Dundeel': { runners: 144, roi: -45.4, strikeRate: 9.0 },
    'Maschino': { runners: 51, roi: -46.0, strikeRate: 11.8 },
    'Vadamos': { runners: 22, roi: -46.4, strikeRate: 13.6 },
    'Flying Artie': { runners: 103, roi: -47.3, strikeRate: 7.8 },
    'Headwater': { runners: 84, roi: -47.6, strikeRate: 9.5 },
    'The Autumn Sun': { runners: 75, roi: -48.3, strikeRate: 10.7 },
    'Maurice': { runners: 64, roi: -49.7, strikeRate: 12.5 },
    'Foxwedge': { runners: 64, roi: -50.2, strikeRate: 9.4 },
    'Deep Field': { runners: 113, roi: -51.1, strikeRate: 12.4 },
    'Kermadec': { runners: 31, roi: -51.1, strikeRate: 12.9 },
    'Pride Of Dubai': { runners: 71, roi: -52.7, strikeRate: 7.0 },
    'Spirit Of Boom': { runners: 89, roi: -52.9, strikeRate: 6.7 },
    'Brazen Beau': { runners: 46, roi: -52.9, strikeRate: 13.0 },
    'Written Tycoon': { runners: 159, roi: -53.4, strikeRate: 11.3 },
    'Spieth': { runners: 30, roi: -53.8, strikeRate: 10.0 },
    'Sir Prancealot': { runners: 57, roi: -54.9, strikeRate: 5.3 },
    'Farnan': { runners: 42, roi: -55.7, strikeRate: 16.7 },
    'Magna Grecia': { runners: 28, roi: -56.8, strikeRate: 10.7 },
    'Winning Rupert': { runners: 42, roi: -57.1, strikeRate: 4.8 },
    'Royal Meeting': { runners: 30, roi: -57.7, strikeRate: 10.0 },
    'Per Incanto': { runners: 49, roi: -58.2, strikeRate: 8.2 },
    'Adelaide': { runners: 37, roi: -58.9, strikeRate: 5.4 },
    'Xtravagant': { runners: 35, roi: -59.1, strikeRate: 11.4 },
    'Better Than Ready': { runners: 111, roi: -59.8, strikeRate: 8.1 },
    
    // DISASTER SIRES (-60%+ ROI)
    'Ilovethiscity': { runners: 30, roi: -60.0, strikeRate: 3.3 },
    'Casino Prince': { runners: 54, roi: -60.2, strikeRate: 9.3 },
    'Needs Further': { runners: 47, roi: -61.7, strikeRate: 14.9 },
    'Too Darn Hot': { runners: 78, roi: -61.8, strikeRate: 9.0 },
    'Calyx': { runners: 27, roi: -62.2, strikeRate: 11.1 },
    'Supido': { runners: 52, roi: -63.1, strikeRate: 7.7 },
    'Almanzor': { runners: 58, roi: -64.0, strikeRate: 12.1 },
    'Universal Ruler': { runners: 49, roi: -64.3, strikeRate: 2.0 },
    'Shamus Award': { runners: 95, roi: -65.8, strikeRate: 11.6 },
    'Invader': { runners: 47, roi: -66.2, strikeRate: 4.3 },
    'Fiorente': { runners: 55, roi: -66.5, strikeRate: 7.3 },
    'Vancouver': { runners: 33, roi: -66.7, strikeRate: 3.0 },
    'Lean Mean Machine': { runners: 26, roi: -66.9, strikeRate: 11.5 },
    'Alpine Eagle': { runners: 56, roi: -67.0, strikeRate: 7.1 },
    'Shalaa': { runners: 81, roi: -67.0, strikeRate: 8.6 },
    'Snippetson': { runners: 31, roi: -69.4, strikeRate: 3.2 },
    'Ocean Park': { runners: 67, roi: -70.4, strikeRate: 4.5 },
    'Dissident': { runners: 31, roi: -71.0, strikeRate: 3.2 },
    'Akeed Mofeed': { runners: 26, roi: -71.2, strikeRate: 7.7 },
    'Nostradamus': { runners: 22, roi: -72.7, strikeRate: 4.5 },
    'Turn Me Loose': { runners: 22, roi: -72.7, strikeRate: 4.5 },
    'King\'s Legacy': { runners: 21, roi: -73.8, strikeRate: 4.8 },
    'Pariah': { runners: 82, roi: -75.1, strikeRate: 3.7 },
    'Zousain': { runners: 71, roi: -76.7, strikeRate: 9.9 },
    'American Pharoah': { runners: 44, roi: -77.2, strikeRate: 6.8 },
    'Sacred Falls': { runners: 22, roi: -77.3, strikeRate: 4.5 },
    'Dubious': { runners: 28, roi: -77.9, strikeRate: 10.7 },
    'Tavistock': { runners: 26, roi: -78.5, strikeRate: 3.8 },
    'Impending': { runners: 86, roi: -78.6, strikeRate: 4.7 },
    'Merchant Navy': { runners: 58, roi: -78.7, strikeRate: 6.9 },
    'Manhattan Rain': { runners: 31, roi: -79.0, strikeRate: 3.2 },
    'Doubtland': { runners: 15, roi: -79.3, strikeRate: 13.3 },
    'Boulder City': { runners: 18, roi: -79.4, strikeRate: 5.6 },
    'Anders': { runners: 26, roi: -79.6, strikeRate: 7.7 },
    'Safeguard': { runners: 20, roi: -80.0, strikeRate: 5.0 },
    'Star Witness': { runners: 48, roi: -80.2, strikeRate: 4.2 },
    'Your Song': { runners: 29, roi: -82.8, strikeRate: 3.4 },
    'Holler': { runners: 21, roi: -82.9, strikeRate: 4.8 },
    'God Has Spoken': { runners: 17, roi: -84.1, strikeRate: 5.9 },
    'Bel Esprit': { runners: 26, roi: -84.6, strikeRate: 3.8 },
    'Encryption': { runners: 26, roi: -86.2, strikeRate: 3.8 },
    'Ardrossan': { runners: 20, roi: -86.8, strikeRate: 5.0 },
    'Brutal': { runners: 44, roi: -87.0, strikeRate: 6.8 },
    'Unite And Conquer': { runners: 19, roi: -87.4, strikeRate: 5.3 },
    'Ole Kirk': { runners: 25, roi: -87.6, strikeRate: 4.0 },
    'Soul Patch': { runners: 14, roi: -87.9, strikeRate: 7.1 },
    'Rubick': { runners: 70, roi: -90.4, strikeRate: 2.9 },
    'Lope De Vega': { runners: 21, roi: -90.5, strikeRate: 4.8 },
    'Super One': { runners: 58, roi: -91.7, strikeRate: 1.7 },
    'Heroic Valour': { runners: 35, roi: -92.0, strikeRate: 2.9 },
    'North Pacific': { runners: 28, roi: -92.9, strikeRate: 3.6 },
    'Wandjina': { runners: 34, roi: -93.8, strikeRate: 2.9 },
    'Shooting To Win': { runners: 60, roi: -94.3, strikeRate: 1.7 },
    
    // ZERO WINNERS (-100% ROI)
    'Outreach': { runners: 39, roi: -100.0, strikeRate: 0.0 },
    'Reliable Man': { runners: 36, roi: -100.0, strikeRate: 0.0 },
    'Squamosa': { runners: 30, roi: -100.0, strikeRate: 0.0 }
};
